...
/**
 * @brief Cuda implementation of wrapper around 2D vertex and normal maps.
 * 
...
class SurfaceCuda {
    public:
         ...
         */
        SurfaceCuda(std::size_t height, std::size_t width):
         ...
         */
        inline Map2DVector3fCuda& getVertexMap() {
            return vertexMap;
        }
         ...
         * @return Map2DVector3f& Vertex map
         */
        inline Map2DVector3fCuda& getNormalMap() {
            return normalMap;
        }

    private:
        /// See Surface description.
        Map2DVector3fCuda vertexMap;
        Map2DVector3fCuda normalMap;
    };
} // namespace kinect_fusion